...
public class CircleV2 extends ShapeV2 { //Child-Klasse: Erbt von Shape alle Attribute & Methoden. (Kann bei Bedarf erweitern/überschreiben)
    private int diameter; //privates Attribut. Speichert den Durchmesser des Kreises.

    public CircleV2(int x, int y, int diameter) { //Konstruktor der Circle-Klasse.
